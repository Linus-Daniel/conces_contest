          ...
          <div className="container mx-auto py-12">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-700">
                We're sorry, but the Submission period for the contest has
                ended. Please check back later for future contests and
                opportunities.
              </p>
              <p>Thank you for your interest and support!</p>
              <p>Please Submit your Designs if you have signuped already.</p>
            </div>
          </div>
        </div>
      );
